...
class Snake:
    ...
    def __init__(self,head_x,head_y,direction,length=3,board_size=(10,10)):
        ...
        length : int. optional
            length of the snake
        """
        self.head = head_x,head_y  # tuple
        self.direction = direction #string
        self.length = length       #length
        self.body=[self.head]      #list
        self.board_size =  board_size
        for i in range(1, length):   # Generate the body
    ...
    def _move_one_step(self):
        ...
        if self.head[0] < 0 or self.head[0] > self.board_size[0]\
            ...
            return -1     #hit the wall return -1
        return 0          #others return 0
    ...
    def move_one_step_without_eating(self):
        ...
        """
        self._move_one_step()
        self.body.pop()   #delet the end of body
